document.addEventListener('DOMContentLoaded', () => {
    ...
    // Turns a timestamp into a short relative label like "3 min ago"
    ...
    // Shared renderer for the home and pole status cards at the top of the page
    ...
    // Shows the "local vs upstream" outage banner when home and pole disagree
    ...
    // Fills the today/week/month uptime table
    ...
    // Renders this customer's own ticket list
    ...
    // Renders the past outage history table
    ...
    // Fills the "how am I doing vs the neighborhood" comparison line
    ...
    // Submits a new ticket for this home, from either the alert banner or the manual form
    ...
    // Pulls this customer's full snapshot (home, pole, analytics, tickets, history) and redraws the page
    function fetchData() {
